...
class TeachersAndNonTeachingPopulation extends StatefulWidget {
  const TeachersAndNonTeachingPopulation({Key? key}) : super(key: key);

  @override
  State<TeachersAndNonTeachingPopulation> createState() => _TeachersAndNonTeachingPopulationState();
}

class _TeachersAndNonTeachingPopulationState extends State<TeachersAndNonTeachingPopulation> {
        ...
        children: [
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "School Teachers & Non-Teaching Staff Population",
                      style: TextStyle(
                    ...
                    Text.rich(
                      const TextSpan(
                        children: [
                          TextSpan(
                            text: "Please provide the current Student population of Teachers and Non-Teaching Staff",
                            style: TextStyle(
                              fontSize: 18.0,
                              color: Colors.white,
          ...
          BrandBottomNav(
            ...
            function: () async {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_) => const HistoryAndAbout()));
            },
          ),
        ],
      ),
