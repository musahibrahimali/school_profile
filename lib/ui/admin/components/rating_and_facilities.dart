...
class RatingsAndFacilities extends StatefulWidget {
  const RatingsAndFacilities({Key? key}) : super(key: key);

  @override
  State<RatingsAndFacilities> createState() => _RatingsAndFacilitiesState();
}

class _RatingsAndFacilitiesState extends State<RatingsAndFacilities> {
        ...
        children: [
                  ...
                  children: [
                    ...
                    Text.rich(
                      const TextSpan(
                        children: [
                          TextSpan(
                            text: "Please provide your schools current rating and facilities",
                            style: TextStyle(
                              fontSize: 18.0,
                              color: Colors.white,
          ...
          BrandBottomNav(
            ...
            function: () async {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_) => const PerformanceAndFeeRange()));
            },
          ),
        ],
      ),
