...
class PerformanceAndFeeRange extends StatefulWidget {
  const PerformanceAndFeeRange({Key? key}) : super(key: key);

  @override
  State<PerformanceAndFeeRange> createState() => _PerformanceAndFeeRangeState();
}

class _PerformanceAndFeeRangeState extends State<PerformanceAndFeeRange> {
        ...
        children: [
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "School Performance and fee range",
                      style: TextStyle(
          ...
          BrandBottomNav(
            ...
            function: () async {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_) => const ExtraCurricularAndAvatar()));
            },
          ),
        ],
      ),
